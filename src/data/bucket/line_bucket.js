        ...
        for (let i = first; i < len; i++) {
            ...
            if (isSharpCorner && i > first) {
                ...
                if (prevSegmentLength > 2 * sharpCornerOffset) {
                    ...
                    this.addCurrentVertex(newPrevVertex, prevNormal, prevNormal, 0, 0, segment);
            ...
            if (currentJoin === 'miter') {
                ...
                const unmodifiedNormal = joinNormal.clone();
                if (miterLength > 100) {
                ...
                this.addCurrentVertex(currentVertex, joinNormal, unmodifiedNormal, 0, 0, segment);
                this.addCurrentVertex(currentVertex, joinNormal.mult(-1), unmodifiedNormal, 0, 0, segment);
            ...
            if (isSharpCorner && i < len - 1) {
                ...
                if (nextSegmentLength > 2 * sharpCornerOffset) {
                    ...
                    this.addCurrentVertex(newCurrentVertex, nextNormal, nextNormal, 0, 0, segment);
